...
/* 1080p 90fps binning mode - based on sunnic_IMX415_RegisterSetting_Ver10.0_20240925_No1 */
static __maybe_unused const struct regval imx415_linear_12bit_1932x1096_1782M_90fps_regs[] = {
	{0x3020, 0x01},  // HADD - horizontal binning
	{0x3021, 0x01},  // VADD - vertical binning
	{0x3022, 0x01},  // ADDMODE
	{0x3024, 0xD4},  // VMAX[7:0] = 212
	{0x3025, 0x00},  // VMAX[15:8]
	{0x3028, 0x6D},  // HMAX[7:0] = 365
	{0x3029, 0x01},  // HMAX[15:8]
	{0x302C, 0x00},  // Normal mode
	{0x302D, 0x00},
	{0x3031, 0x00},  // ADBIT - 10bit
	{0x3033, 0x05},  // Driver timing
	...
	{0x3060, 0x25},
	{0x3064, 0x4A},
	{0x30CF, 0x00},  // Normal mode (not HDR)
	{0x30D9, 0x02},  // DIG_CLP_VSTART
	{0x30DA, 0x01},  // DIG_CLP_VNUM
	{0x3118, 0xC0},  // INCKSEL3[10:0]
	{0x311A, 0xE0},  // INCKSEL4[10:0] - for 1782Mbps
	{0x3260, 0x01},  // Normal mode
	{0x3701, 0x00},  // ADBIT1
	{0x344C, 0x2B},  // -
	{0x344D, 0x01},  // -
	{0x344E, 0xED},  // -
...
static const struct imx415_mode supported_modes[] = {
	/*
	 * 1080p 90fps binning mode - DEFAULT MODE
	 * Resolution: 1932x1096 (binning from 3864x2192)
	 * Frame rate = 90.011fps
	 * VMAX = 0xD4 = 212
	 * HMAX = 0x016D = 365
	 */
	{
		...
		.reg_list = imx415_linear_12bit_1932x1096_1782M_90fps_regs,
		.hdr_mode = NO_HDR,
		.mipi_freq_idx = 4,  // Will be MIPI_FREQ_1782M (index 4 in link_freq_items)
		.bpp = 12,
