...
static __maybe_unused const struct regval imx415_linear_12bit_1920x1080_90fps_regs[] = {
	{ 0x3000, 0x01 }, // Standby
	...
	{ 0x3BC8, 0xBD }, // -
	{ 0x3BCA, 0xBD }, // -
	{ 0x4004, 0x48 }, // TXCLKESC_FREQ[15:0] (for 1782Mbps)
	{ 0x4005, 0x09 }, //
...
static const struct imx415_mode supported_modes[] = {
	 ...
	 */
	{
		...
		.exp_def = 0x08ca - 0x08,
		.hts_def = 0x01c6 * IMX415_4LANES * 2, // HMAX=0x1C6
		.vts_def = 2250,
		.global_reg_list = NULL,
		.reg_list = imx415_linear_12bit_1920x1080_90fps_regs,
		.hdr_mode = NO_HDR,
		.mipi_freq_idx = 5, // 1782M
		.bpp = 10,
		.vc[PAD0] = 0,
		.xvclk = IMX415_XVCLK_FREQ_74M,
	},
	{
		.bus_fmt = MEDIA_BUS_FMT_SGBRG10_1X10,
		.width = 3864,
